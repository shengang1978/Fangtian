========================================================================
    ACTIVE TEMPLATE LIBRARY : ImageParser Project Overview
========================================================================

AppWizard has created this ImageParser project for you to use as the starting point for
...
ImageParser.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ImageParser.h)
        GUID definitions                                (ImageParser_i.c)
        A type library                                  (ImageParser.tlb)
        Marshaling code                                 (ImageParser_p.c and dlldata.c)

ImageParser.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ImageParser.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ImageParser.pch and a precompiled types file named StdAfx.obj.
...
ImageParserps.vcxproj
	...
	dlldata.c, ImageParser_i.c and ImageParser_p.c which are required
	to build the proxy/stub DLL.

ImageParserps.vcxproj.filters
